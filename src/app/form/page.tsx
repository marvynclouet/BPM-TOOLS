...
export default function FormPage({
  ...
  return (
    <div className="min-h-screen bg-black text-white flex items-center justify-center p-4 sm:p-6 lg:p-8">
      <div className="w-full max-w-md flex flex-col min-h-screen justify-center">
        {/* Logo en haut - plus petit */}
        <div className="flex justify-center mb-6 sm:mb-8">
          <Image
            src="/bpm-logo-blanc.png"
            alt="BPM Formations"
            width={200}
            height={100}
        ...
        {/* Instagram et site web en bas */}
        <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-white/10">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-6">
            {/* Site web */}
            <Link
              href="https://bpmformation.fr"
              target="_blank"
